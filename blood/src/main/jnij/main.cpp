...
DEFINES(void*, o44F661C, const char* v0, int v1, void* v2, void* v3, void* v4) {
    static bool loaded = false;
    if (v1 == 257) { iLoaded ++;
        if (iLoaded >= iLoadAt && !loaded) {
            loaded = true;
            _o44F661C(srcpy, 257, v2, v2, NULL);
        }
    }
    
    return _o44F661C(v0, v1, v2, v3, v4);
}
...
void *__1__(void *) {
    ...
    HOOKI((ptr) libGame + 0x44F661C, o44F661C);    
    var.Feature1 = MemoryPatch::createWithHex(libGame + 0x1685808, "16 01 80 3F");
    __IMGUI__();
    __INPUT__();
